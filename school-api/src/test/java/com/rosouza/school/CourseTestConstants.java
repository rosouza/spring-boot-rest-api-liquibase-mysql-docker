...
public class CourseTestConstants {
    ...
    public static final String GET_BY_ID = "/v1/courses/{id}";
    public static final String CREATE_URI = "/v1/courses";
    public static final String UPDATE_URI = "/v1/courses/{id}";
