...
class StudentRepositoryTest {
    ...
    @Test
    void should_delete_all_student() {
    ...
    @Test
    void should_find_no_student_if_repository_is_empty() {
        var entities = repository.findAll();
        assertThat(entities).isEmpty();
    }

    @Test
    void should_store_a_student() {
    ...
    @Test
    void should_update_student_by_id() {
        var entity1 = entity();
        entityManager.persist(entity1);
